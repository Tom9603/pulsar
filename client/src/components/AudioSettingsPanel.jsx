...
/** Contenu des réglages audio (entrée / sortie, volumes, tests, réinitialisation).
 *  Réutilisé dans la sur-modale audio ET dans l'onglet « Audio » des réglages. */
export default function AudioSettingsPanel() {
  ...
  return (
    <>
      ...
      <div className="field">
        <button className="btn btn-ghost" style={{ width: 'auto', padding: '8px 14px' }} onClick={() => resetAudio()}>
          <Icon name="rotate-left" /> Réinitialiser les paramètres audio
        </button>
      </div>
    </>
  );
